                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.companies.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            ...
                            <input type="text" name="company_number" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block w-full mt-1" required>
                        </div>

                        <div class="mt-4">
                            <label class="block font-medium text-sm text-gray-700">Address:</label>
                            <textarea name="address" rows="3" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block w-full mt-1" required></textarea>
                        </div>

                        <div class="mt-4">
                            <label class="block font-medium text-sm text-gray-700">Phone Number:</label>
                            <input type="text" name="phone" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block w-full mt-1" required>
                        </div>

                        <div class="mt-4">
                            <label class="block font-medium text-sm text-gray-700">Person in Charge (Supervisor):</label>
                            <input type="text" name="person_in_charge" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block w-full mt-1" required>
                        </div>

                        <div class="mt-4">
                            <label class="block font-medium text-sm text-gray-700">Photo (Upload):</label>
